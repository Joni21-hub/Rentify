    ...
    <div class="w-full max-w-[380px] relative z-10 my-[2vh] lg:my-0">
        ...
        <div class="glass-panel p-6 sm:p-8 relative">
            ...
            <div class="text-center mb-6">
                <div class="inline-block px-3 py-1 rounded-full bg-white/30 border border-white/50 text-white text-[9px] font-bold uppercase tracking-widest mb-3 shadow-sm backdrop-blur-sm">
                    Customer Portal
                </div>
            ...
            <form action="{{ route('register') }}" method="POST" class="space-y-3.5">
                ...
                <div class="relative group">
                    <span class="absolute inset-y-0 left-0 flex items-center pl-4 text-slate-600 group-focus-within:text-blue-600 transition"><i class="fa-solid fa-envelope text-xs"></i></span>
                    <input type="email" name="email" value="{{ old('email') }}" required class="input-glass w-full pl-10 pr-4 py-2.5 rounded-2xl text-[11px] focus:outline-none font-bold" placeholder="Alamat Email (Digunakan untuk Login)">
                </div>
                ...
                <div class="relative group">
                    ...
                    <input type="text" name="whatsapp" value="{{ old('whatsapp') }}" required class="input-glass w-full pl-10 pr-4 py-2.5 rounded-2xl text-[11px] focus:outline-none font-bold" placeholder="Nomor WhatsApp (Digunakan untuk OTP)">
                </div>
