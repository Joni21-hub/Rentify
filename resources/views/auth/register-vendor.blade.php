            ...
            <form action="/vendor/register" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" required class="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 focus:bg-white transition-all text-slate-700" placeholder="Sesuai kartu identitas">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="vendor_name" required class="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 focus:bg-white transition-all text-slate-700" placeholder="Contoh: Rentify">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" required class="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 focus:bg-white transition-all text-slate-700" placeholder="vendor@email.com">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="whatsapp_vendor" required class="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 focus:bg-white transition-all text-slate-700" placeholder="081234567xxx">
                        </div>
                    </div>
                </div>
                ...
                <!-- KOTAK CENTANG S&K VENDOR -->
                <div class="flex items-start mt-4 mb-2">
                    <div class="flex items-center h-5">
                        <input id="terms_vendor" name="terms" type="checkbox" required
                            class="w-4 h-4 border border-slate-300 rounded bg-slate-50 focus:ring-3 focus:ring-blue-500 checked:bg-blue-600 text-blue-600 transition cursor-pointer">
                    </div>
                    <div class="ml-3 text-[11px]">
                        <label for="terms_vendor" class="font-medium text-slate-500 cursor-pointer leading-tight block">
                            Saya menyatakan data di atas asli, dan menyetujui seluruh 
                            <a href="/syarat-ketentuan" target="_blank" class="font-bold text-blue-600 hover:text-blue-800 hover:underline transition">Syarat & Ketentuan</a> 
                            Vendor Rentify.
                        </label>
                    </div>
                </div>
