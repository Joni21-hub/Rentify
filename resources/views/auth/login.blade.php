...
<head>
    ...
    <style>
        ...
        /* BACKGROUND MENGALIR YANG LEBIH HIDUP DAN KAYA WARNA */
        ...
        .glass-panel {
            ...
            backdrop-filter: blur(25px); /* Blur yang kuat agar seperti kaca tebal */
...
<body class="min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden bg-flowing text-slate-800">
    ...
    <!-- BOLA CAHAYA MEMBUAT BACKGROUND MAKIN HIDUP -->
    ...
    <div class="w-full max-w-[380px] relative z-10">
        ...
        <div class="glass-panel p-8 sm:p-10 relative">
            ...
            <div class="text-center mb-8">
                <div class="inline-block px-4 py-1.5 rounded-full bg-white/30 border border-white/50 text-white text-[10px] font-bold uppercase tracking-widest mb-4 shadow-sm backdrop-blur-sm">
                    Customer Portal
                </div>
