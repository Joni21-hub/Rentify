        ...
        <div style="margin: 25px 0; border-top: 2px dashed #cbd5e1; padding-top: 20px;">
            ...
            @foreach($keranjangPerVendor as $vendorId => $items)
                @php 
                    ...
                    // KUNCI SAKTI: Mengambil jadwal akurat dari database order asli
                ...
                <div style="background: #f8fafc; padding: 18px; border-radius: 12px; margin-bottom: 16px; border: 1px solid #cbd5e1; box-shadow: 0 2px 5px rgba(0,0,0,0.02);">
                    ...
                    <!-- BLOK JADWAL PEMAKAIAN (STRUK) -->
                    <div style="background: #f0f9ff; border: 1px solid #bae6fd; padding: 12px 14px; border-radius: 10px; margin-top: 12px;">
                        ...
                        <div style="font-size: 12.5px; font-weight: 800; color: #0f172a; display: flex; justify-content: space-between; margin-bottom: 4px;">
                            <span style="color: #64748b;">Mulai Ambil:</span>
                            <span style="color: #0284c7;">{{ $waktuMulai->format('d M Y - H:i') }} WIB</span>
                        </div>
                        <div style="font-size: 12.5px; font-weight: 800; color: #0f172a; display: flex; justify-content: space-between;">
                            <span style="color: #64748b;">Maks Kembali:</span>
                            <span style="color: #0ea5e9;">{{ $waktuKembali->format('d M Y - H:i') }} WIB</span>
                        </div>
                    </div>
